...
namespace GameServer
{
	...
	public:
        ...
        bool OnStart(boost::asio::ip::tcp::socket* socket) override
        {
            ...
            {
                boost::asio::socket_base::receive_buffer_size option(m_OperatingSystemReceiveBufferSize);
            ...
            {
                boost::asio::socket_base::send_buffer_size option(m_OperatingSystemSendBufferSize);
